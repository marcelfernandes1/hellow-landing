        ...
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              Now answering for 1,200+ local businesses
            </motion.div>
            ...
            >
              ...
              <span className="font-display-italic text-coral-600">Ever.</span>
            </motion.h1>
            ...
            >
              ...
              and captures leads <span className="text-ink">24/7</span> — so you can focus
            ...
            >
              Hellow will pick up. Try anything — book an appointment, ask a question. It's a real demo.
            </motion.p>
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs">
                  Join thousands of local businesses using AI to answer every call
                </span>
              </div>
            </motion.div>
          </div>
