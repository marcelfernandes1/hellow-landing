  ...
  return (
    <div ref={containerRef} className="relative mx-auto w-full max-w-[360px]">
        ...
        <div className="relative h-full w-full overflow-hidden rounded-[36px] bg-bg-soft">
          ...
          <div className="px-5 pt-8">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] font-medium text-ink-muted">00:42</span>
            </div>
            ...
            <div className="mt-4 flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[11px] text-ink-muted">+1 (415) 555 · New caller</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2.5 px-5 pt-5">
            ...
            {visibleLines >= SCRIPT.length && (
              ...
              >
                <Sparkles className="h-3 w-3" /> Appointment booked
              </motion.div>
            )}
          </div>
      ...
      >
        ...
        <div className="mt-2 font-display text-base font-semibold text-ink">Tue · 2:00 PM</div>
        <div className="text-xs text-ink-muted">Cleaning · Sarah M.</div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-coral-300">
          <Phone className="h-3.5 w-3.5" /> 24/7 answering
        </div>
        <div className="mt-2 font-display text-2xl font-semibold leading-none">847</div>
        <div className="text-[11px] text-white/60">calls answered this week</div>
      </motion.div>
    </div>
  );
}
